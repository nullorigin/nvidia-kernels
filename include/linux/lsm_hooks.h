...
#define LSM_HOOK_INIT(NAME, HOOK)                                              \
  {                                                                            \
    .scalls = static_calls_table.NAME, .hook = {.NAME = HOOK }                 \
  }
...
#define DEFINE_LSM(lsm)                                                        \
  static struct lsm_info __lsm_##lsm __used __section(".lsm_info.init")        \
      __aligned(sizeof(unsigned long))

#define DEFINE_EARLY_LSM(lsm)                                                  \
  static struct lsm_info __early_lsm_##lsm __used __section(                   \
      ".early_lsm_info.init") __aligned(sizeof(unsigned long))
