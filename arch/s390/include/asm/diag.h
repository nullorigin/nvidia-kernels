 ...
 */
static inline void diag10_range(unsigned long start_pfn,
...
#define DIAG204_CPU_NAME_LEN                                                   \
  16 /* type name len of cpus in diag224 name table */
...
enum diag204_format { DIAG204_INFO_SIMPLE = 0, DIAG204_INFO_EXT = 0x00010000 };
...
static inline bool diag204_has_bif(void) { return sclp.has_diag204_bif; }
...
int _diag26c_amode31(unsigned long rx, unsigned long rx1,
...
/* diag 49c subcodes */
enum diag49c_sc { DIAG49C_SUBC_ACK = 0, DIAG49C_SUBC_REG = 1 };
